...
import (
	...
	"github.com/AdGuardPrivate/dnsproxy/fastip"
	"github.com/AdGuardPrivate/dnsproxy/internal/dnsmsg"
	proxynetutil "github.com/AdGuardPrivate/dnsproxy/internal/netutil"
...
func (p *Proxy) cacheWorks(dctx *DNSContext) (ok bool) {
	...
	case dctx.CustomUpstreamConfig != nil && dctx.CustomUpstreamConfig.cache == nil:
		...
		// cache.
		//
		// See https://github.com/AdGuardPrivate/dnsproxy/issues/169.
